...
# DATA_ROOT_DIR_new = '../../data/InterNeRF/data/'
# VGN_TRAIN_ROOT_new = DATA_ROOT_DIR_new + 'giga_hemisphere_train_0827'
...
if os.path.exists(VGN_TRAIN_ROOT):
    ...
    # vgn_pile_train_scene_names = sorted(add_scenes(os.path.join(VGN_TRAIN_ROOT_new, 'pile_full'), 'pile'), key=lambda x: x.split('/')[4])
...
# CSV_ROOT_new = DATA_ROOT_DIR_new + 'GIGA'
...
# VGN_PILE_TRAIN_CSV = pd.read_csv(Path(CSV_ROOT_new + '/data_pile_train_processed_dex_noise/grasps.csv'))
